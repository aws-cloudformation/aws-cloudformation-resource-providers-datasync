...
public class UpdateHandlerTest {
    ...
    @Test
    public void handleRequest_LocationAndTagsUpdateSuccess() {
        final UpdateHandler handler = new UpdateHandler();
    ...
    public void handleRequest_FailureNotFoundRequest() {
        ...
        doThrow(InvalidRequestException.class)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(UpdateLocationObjectStorageRequest.class), any());
    ...
    private static DescribeLocationObjectStorageResponse buildDefaultResponse() {
        final String locationArn = "arn:aws:datasync:us-west-2:123456789012:location/loc-1234567890123456";
        final String locationUri = "object-storage://10.0.1.0/random-bucket";
        return DescribeLocationObjectStorageResponse.builder()
