...
public class ReadHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        assertThat(response.getResourceModel()).isEqualToComparingOnlyGivenFields(describeLocationS3Response,
    ...
    public void handleRequest_FailureNotFoundRequest() {
        ...
        doThrow(InvalidRequestException.class)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(DescribeLocationS3Request.class), any());
    ...
    private static DescribeLocationS3Response buildDefaultResponse() {
        ...
        return DescribeLocationS3Response.builder()
