...
public class DeleteHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteTaskResponse deleteTaskResponse = DeleteTaskResponse.builder()
                .build();

        doReturn(deleteTaskResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(
                        any(DeleteTaskRequest.class),
                        any()
                );
    ...
    public void handleRequest_FailureNotFoundRequest() {
        ...
        doThrow(InvalidRequestException.class)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(DeleteTaskRequest.class), any());
