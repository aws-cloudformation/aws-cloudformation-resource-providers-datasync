...
public class ReadHandler extends BaseHandler<CallbackContext> {
    ...
    public ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        try {
            ...
            throw new CfnServiceInternalErrorException(describeLocationFsxWindowsRequest.toString(), e.getCause());
        } catch (DataSyncException e) {
            throw new CfnGeneralServiceException(describeLocationFsxWindowsRequest.toString(), e.getCause());
        }
