...
public class ReadHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        assertThat(response.getResourceModel()).isEqualToComparingOnlyGivenFields(describeLocationEfsResponse,
    ...
    public void handleRequest_FailureNotFoundRequest() {
        ...
        doThrow(InvalidRequestException.class)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(DescribeLocationEfsRequest.class), any());
