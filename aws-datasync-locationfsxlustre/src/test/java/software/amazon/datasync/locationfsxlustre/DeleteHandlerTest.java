...
public class DeleteHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteLocationResponse deleteLocationResponse = DeleteLocationResponse.builder()
                .build();

        doReturn(deleteLocationResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(DeleteLocationRequest.class), any());
    ...
    private static ResourceModel buildDefaultModel() {
        final String locationArn = "arn:aws:datasync:us-east-1:123456789012:location/loc-12345678901234567";
