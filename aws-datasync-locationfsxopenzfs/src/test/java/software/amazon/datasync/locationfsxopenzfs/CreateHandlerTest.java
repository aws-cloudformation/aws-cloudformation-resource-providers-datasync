...
public class CreateHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final CreateLocationFsxOpenZfsResponse createLocationFsxOpenZfsResponse =
                CreateLocationFsxOpenZfsResponse.builder().build();

        final DescribeLocationFsxOpenZfsResponse describeLocationFsxOpenZfsResponse =
                DescribeLocationFsxOpenZfsResponse.builder().build();

        final ListTagsForResourceResponse listTagsForResourceResponse =
                TagTestResources.buildTagsWithSystemTagResponse();

        doReturn(createLocationFsxOpenZfsResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(CreateLocationFsxOpenZfsRequest.class), any());
    ...
    public void handleRequest_InvalidSystemTagRequest() {
        ...
        System.out.println(request.getSystemTags());
    ...
    private static ResourceModel buildDefaultModel() {
        ...
        final String securityGroupArn = "arn:aws:ec2:us-east-1:123456789012:security-group/sg-12345678";
        List<String> securityGroupArns = new ArrayList<String>() {{
            add(securityGroupArn);
        }};
        final Protocol protocol = Protocol.builder().build();
